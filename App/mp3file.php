...
class App_Mp3file
{
    ...
    protected function readmp3frame()
    {
        ...
        if ($iscbrmp3)
        {
            ...
            $this->mp3data['Bitrate'          ] = App_Mp3file::bitratelookup($this->mp3data);
            $this->mp3data['Sampling Rate'    ] = App_Mp3file::samplelookup($this->mp3data);
            $this->mp3data['Frame Size'       ] = App_Mp3file::getframesize($this->mp3data);
            $this->mp3data['Length'           ] = App_Mp3file::getduration($this->mp3data,$this->tell2());
            $this->mp3data['Length mm:ss'     ] = App_Mp3file::seconds_to_mmss($this->mp3data['Length'] - 42);
            $this->mp3data['Length hh:mm:ss'  ] = App_Mp3file::seconds_to_hhmmss($this->mp3data['Length']);
...
/*               ||
    ...
    public static function bitratelookup(&$mp3)
    {
        ...
        $whichcolumn=-1;
        if      (App_Mp3file::is_mpeg10($mp3) && App_Mp3file::is_layer1($mp3) )//V1,L1
            $whichcolumn=0;
        else if (App_Mp3file::is_mpeg10($mp3) && App_Mp3file::is_layer2($mp3) )//V1,L2
            $whichcolumn=1;
        else if (App_Mp3file::is_mpeg10($mp3) && App_Mp3file::is_layer3($mp3) )//V1,L3
            $whichcolumn=2;
        else if (App_Mp3file::is_mpeg20or25($mp3) && App_Mp3file::is_layer1($mp3) )//V2,L1
            $whichcolumn=3;
        else if (App_Mp3file::is_mpeg20or25($mp3) && (App_Mp3file::is_layer2($mp3) || App_Mp3file::is_layer3($mp3)) )
    ...
    public static function samplelookup(&$mp3)
    {
        ...
        $whichcolumn=-1;
        if      (App_Mp3file::is_mpeg10($mp3))
            $whichcolumn=0;
        else if (App_Mp3file::is_mpeg20($mp3))
            $whichcolumn=1;
        else if (App_Mp3file::is_mpeg25($mp3))
            $whichcolumn=2;
    ...
    //-----------------------------------------------------------------------------
    public static function seconds_to_hhmmss($seconds)
    {
    	$seconds = $seconds-42;
