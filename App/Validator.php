 ...
 * @see Based on idea: https://github.com/blackbelt/php-validation
 */
class App_Validator {
    ...
    public function string($message = null) {
        $this->setRule(__FUNCTION__, function($val) {
            return (strlen(trim($val)) !== 0 && filter_var($val, FILTER_SANITIZE_STRING) !== FALSE && is_string($val));
        }, $message);
        return $this;
    }
     ...
     * @return FormValidator
     */
    public function file($message = null) {
        $this->setRule(__FUNCTION__, function($val) {
        	$val_1255 = iconv ("UTF-8","windows-1255", $val );
            return is_file($val_1255) ? $val_1255 : false;
        }, $message);
        return $this;
    }
